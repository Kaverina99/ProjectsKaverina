    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Realty", x => x.RealtyId);
                    table.ForeignKey(
                        name: "FK_Realty_Klient_KlientId",
                        column: x => x.KlientId,
                        principalTable: "Klient",
                        principalColumn: "KlientId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Realty_Property_PropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RealtyId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sale_Realty_RealtyId",
                        column: x => x.RealtyId,
                        principalTable: "Realty",
                        principalColumn: "RealtyId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Realty_KlientId",
                table: "Realty",
                column: "KlientId");

            migrationBuilder.CreateIndex(
                name: "IX_Realty_PropertyId",
                table: "Realty",
                column: "PropertyId");
