...
<header class="top-header">
    <nav class="navbar header-nav navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="/"><img src="/images/logo.gif" alt="image"></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                ...
                echo Nav::widget([
                        'items' => [
                            ['label' => 'О предприятии', 'url' => ['/site/index'],
                                'options'=>['class'=>'dropdown'],
                                'items' => [
                                    ['label' => '- Региональные представители', 'url' => ['/site/regions']],
                                    ['label' => '- Сервисное обслуживание', 'url' => ['/site/servis']],
                                    ['label' => '- Сертификаты', 'url' => ['/site/sertif']],
                                    ['label' => '- Патенты', 'url' => ['/site/patents']]
                                ]
                            ],
                            ...
                            Yii::$app->user->isGuest ? (
                                ...
                                (
                                    User::find()->asArray()->where(['id' => Yii::$app->user->identity->getId()])->all()[0][roleFK] == 1 ? (
                                        '<li>'
                                        ...
                                        . '</li>'
                                            ...
                                            User::find()->asArray()->where(['id' => Yii::$app->user->identity->getId()])->all()[0][roleFK] == 2 ? (
                                                 '<li>'
        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class="bottom_menu">
                    ...
                    <li><a href="/index.php?r=site/product">Продукция</a></li>
                    <li><a href="/index.php?r=site/order">Заказать</a></li>
                    <li><a href="/index.php?r=site/contact">Контакты</a></li>
                    <li><a href="/index.php?r=site/office">Личный кабинет</a></li>
                </ul>
            </div>
        </div>
    </div>
