    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <div class="form-group">
                ...
                <table width="30%">
                    <tr>
                        <td align="center"><a href="/index.php?r=site/login" class="btn btn-primary">Войти</a></td>
                        <td align="center"><a href="/index.php?r=site/signup" class="btn btn-primary">Зарегистрироваться</a></td>
                    </tr>
                </table>
            </div>
        </div>
